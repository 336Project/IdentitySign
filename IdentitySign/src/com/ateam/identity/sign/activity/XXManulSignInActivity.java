...
public class XXManulSignInActivity extends HBaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ifHaveNet=SysUtil.isNetworkConnected(XXManulSignInActivity.this);
		if(ifHaveNet){
			getStudentList();
		}else{
	...
	public void onClick(View v) {
		...
		case R.id.tv_showDate:
			SysUtil.showDateListener(XXManulSignInActivity.this, mTvTime);
			break;
			
		case R.id.btn_signin:
			if(mStudentCard.equals("")){
				MyToast.showShort(XXManulSignInActivity.this, "您还未选择签到人员!");
				return;
			}
			signin();
			break;
	...
	private void signin(){
		...
		SignAccess access=new SignAccess(XXManulSignInActivity.this, request);
	...
	private void setListAdaptor() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				MyToast.showShort(XXManulSignInActivity.this, ""+mListStudentOrder.get(arg2).getName()+"  "+
